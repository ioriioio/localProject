          ...
          <div class="col">
            ...
            <div class="col container w-50 border mt-5">
              ...
              <dl class="d-flex align-items-center flex-wrap">
                ...
                <dt class="w-50">カテゴリー</dt>
                  <dd class="w-50">{{$contents['category']}}</dd>
              </dl>
              <form action="upmovieinsert" method="post" class="d-flex align-items-center flex-wrap">
                ...
                <input type="hidden" value="{{$contents['category']}}" name="category">

                <button name="back" formaction="communityUpload" class="btn btn-light text-center">戻る</button>
                <button class="btn btn-primary text-center" formaction="communityUploadInsert">確認</button>
