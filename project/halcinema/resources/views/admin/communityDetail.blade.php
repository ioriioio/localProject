  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
        ...
        <main class="main">
          ...
          @if(session('flashMsg'))
            ...
            <p class="text-center">以上のコメントを削除しました</p>
          @endif
          <div class="col">
              ...
              <table class="table table-striped table-sm text-center">
                ...
                @foreach($contents as $content)
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$content->id}}">削除</button>
                    </td>
                  </tr>
                @endforeach
                </tbody>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    id：{{$dele->id}}<br />
                    ユーザーID：{{$dele->user_id}}<br />
                    コメント：{{$dele->comment}}<br />
                    この投稿を削除してもよろしいでしょうか？
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">閉じる</button>
                    <form action="communityCommentDelete/{{$dele->id}}">
